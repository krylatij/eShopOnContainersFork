namespace Microsoft.eShopOnContainers.Services.Ordering.Domain.AggregatesModel.OrderAggregate
{
        ...
        : Enumeration
    {
        ...
        public static OrderStatus AwaitingStockValidation = new OrderStatus(2, nameof(AwaitingStockValidation));
        public static OrderStatus AwaitingCouponValidation = new OrderStatus(3, nameof(AwaitingCouponValidation));
        public static OrderStatus Validated = new OrderStatus(4, nameof(Validated));
